jQuery(function() {
    /* Tools */
    var tools = '<div id="tools"><h3>Options</h3><div class="content"><h4>Layout type:</h4><a href="#" id="liquid" class="layout"><span class="active">liquid</span></a><a href="#" id="fixed" class="layout"><span>fixed</span></a><h4 class="color">Layout color:</h4><ul id="tools_colors"><li class="red"><a href="#" class="active">red</a></li><li class="blue"><a href="#">blue</a></li><li class="orange"><a href="#">orange</a></li><li class="green"><a href="#">green</a></li><li class="grey"><a href="#">grey</a></li><li class="dark_blue"><a href="#">dark_blue</a></li><li class="dark_grey"><a href="#">dark_grey</a></li></ul></div></div>';
    var bd = jQuery('body');
    bd.append(tools);
    ...
    jQuery('#tools_colors a').bind('click', function() {
    ...
    jQuery('#tools h3').bind('click', function() {
    ...
    jQuery('#tools a.layout').bind('click', function() {
